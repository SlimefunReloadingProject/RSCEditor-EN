...
public class RecipeMachineEditor extends AbstractContainer {
    private static final MenuMatrix matrix = new MenuMatrix()
            ...
            .addItem("G", Icons.build_recipe_machine);

    public RecipeMachineEditor(@NotNull SlimefunItemStack item) {
        super(item);
    }
        ...
        return new BlockMenuPreset(getId(), getItemName()) {
            ...
            public void newInstance(@NotNull BlockMenu menu, @NotNull Block b) {
                ...
                menu.addMenuClickHandler(matrix.getChar("G"), (p, s, i, a) -> {
                    ...
                    ClipboardUtil.send(p, "Recipe Machine Editor: ", writer.toString());
