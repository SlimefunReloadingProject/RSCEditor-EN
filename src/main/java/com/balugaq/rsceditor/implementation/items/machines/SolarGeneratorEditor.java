 ...
 */
public class SolarGeneratorEditor extends AbstractContainer {
    private static final MenuMatrix matrix = new MenuMatrix()
            ...
            .addItem("G", Icons.build_solar_generator);

    public SolarGeneratorEditor(@NotNull SlimefunItemStack item) {
        super(item);
    }
        ...
        return new BlockMenuPreset(getId(), getItemName()) {
            ...
            public void newInstance(@NotNull BlockMenu menu, @NotNull Block b) {
                ...
                menu.addMenuClickHandler(matrix.getChar("G"), (p, s, i, a) -> {
                    ...
                    writer.set("dayEnergy", dayEnergy);
                    ...
                    writer.set("nightEnergy", nightEnergy);
                    ...
                    writer.set("lightLevel", lightLevel);
